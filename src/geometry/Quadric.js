...
export class Quadric {
    ...
    gradient(p) {
        ...
        const y = p.y - this.center.y;
        const z = p.z - this.center.z;
        return new Vector3(2 * this.A * x + this.D * y + this.E * z + this.G, 2 * this.B * y + this.D * x + this.F * z + this.H, 2 * this.C * z + this.E * x + this.F * y + this.I);
    }
    hit(ray) {
        ...
        const b = 2 * this.A * ox * dx +
            ...
            this.H * dy +
            this.I * dz;
        const c = this.evaluate(ray.origin);
