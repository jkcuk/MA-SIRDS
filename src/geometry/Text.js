...
export class Text {
     ...
     */
    constructor(center, hAxis, vAxis, width, height, text, font = "bold 64px sans-serif", material) {
        this.center = center;
        this.hAxis = hAxis;
        this.vAxis = vAxis;
        this.width = width;
        ...
        // underlying geometry
        this.rect = new Rectangle(center, hAxis, vAxis, width, height, material);
        // generate alpha mask
